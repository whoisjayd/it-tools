...
<template>
  <div max-w-600px>
    ...
    <c-card v-if="!result.error" title="WCAG 2.1">
      <input-copyable readonly label="WCAG Constrast:" label-width="130px" label-position="left" :value="result.wcag21ConstrastValue" mb-3 />
      ...
      <c-card title="Large text">
        <n-p><i>Text that is 14pt (18.67px) and bold or any text bigger than 18pt (24px) is defined as large scale text.</i></n-p>
        <n-form-item label="WCAG 2.1 AA:" label-width="130px" label-placement="left">
    ...
    <c-card v-if="!result.error" title="APCA">
      <input-copyable readonly label="APCA Constrast:" label-width="130px" label-position="left" :value="result.apcaContrastValue" mb-2 />
    </c-card>
  </div>
</template>
