...
import { DefaultsMap, Formats, ModelType } from './lib/formats';
...
const inputOptions = Object.keys(Formats).map(key => ({ label: Formats[key], value: Formats[key] }));
...
function onChangeInputTypeHandler(value) {
